...
import fourth from "assets/front-images/3.jpeg"
        ...
        <div className="container">
          <div className="row no-gutters slider-text align-items-center justify-content-center">
            <div className="col-md-7 text-center">
              ...
              <p><a href="/auth/register" className="btn btn-white btn-outline-white px-4 py-3 popup-vimeo"><span className="icon-play mr-2"></span>Register as NGO</a></p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="col-md d-flex justify-content-center counter-wrap">
              <div className="block-18 color-2 align-items-stretch">
                <div className="text">
                  ...
                  <p><a href="/donations" className="btn btn-white px-3 py-2 mt-2">Donate Now</a></p>
                </div>
              </div>
            </div>
            <div className="col-md d-flex justify-content-center counter-wrap">
